...
#define HC165_CASCADE_LENGTH 1     // single 74HC164 is default
#define HC165_CASCADE_MAX_LENGTH 4 // max number of 74HC164 supported by this implementation
#define HC165_PI_PIN_COUNT 8       // number of parallel input pins
...
class HC165ExpanderAdapter : public GpioExpanderAdapter {
  public:
    HC165ExpanderAdapter(byte dataPin, byte clockPin, byte shldPin, byte cascadeLength = HC165_CASCADE_LENGTH,
        ...
        cascadeLength = cascadeLength > HC165_CASCADE_MAX_LENGTH ? HC165_CASCADE_MAX_LENGTH : cascadeLength;
    }
    ...
    uint32_t update() {
        ...
        // Step 2: Read & Shift
        for (int i = 0; i < cascadeLength * HC165_PI_PIN_COUNT; i++) {
